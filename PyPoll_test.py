...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        if candidate_name not in candidate_options:
            ...
            # And Begin tracking that candidte's vote count.
...
with open(file_to_save, "w") as txt_file:
    ...
    # Save the final vote count to the the text file.
    ...
    for candidate_name in candidate_votes:
        ...
        # Print each candidate's voter count and percentage o the terminal.
    ...
    winning_candidate_summary = (
        ...
        f"Winning Percentage_tester: {winning_percentage:.1f}%\n"
        f"---------------------------\n")
